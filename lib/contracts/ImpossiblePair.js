...
class ImpossiblePair extends eth_contract_1.Contract {
    ...
    decodeChangeInvariantEvent(event) {
        ...
        return {
            ...
            newBoost0: new eth_contract_1.BigNumber(result._newBoost0),
            newBoost1: new eth_contract_1.BigNumber(result._newBoost1),
            _event: event
        };
    }
    ...
    decodeUpdatedBoostEvent(event) {
        let result = event.data;
        return {
            oldBoost0: new eth_contract_1.BigNumber(result._oldBoost0),
            oldBoost1: new eth_contract_1.BigNumber(result._oldBoost1),
            newBoost0: new eth_contract_1.BigNumber(result._newBoost0),
            newBoost1: new eth_contract_1.BigNumber(result._newBoost1),
            start: new eth_contract_1.BigNumber(result._start),
            end: new eth_contract_1.BigNumber(result._end),
            _event: event
        };
    }
    ...
    decodeUpdatedDelayEvent(event) {
        let result = event.data;
        return {
            oldDelay: new eth_contract_1.BigNumber(result._oldDelay),
            newDelay: new eth_contract_1.BigNumber(result._newDelay),
            _event: event
        };
    }
    ...
    decodeUpdatedTradeFeesEvent(event) {
        let result = event.data;
        return {
            oldFee: new eth_contract_1.BigNumber(result._oldFee),
            newFee: new eth_contract_1.BigNumber(result._newFee),
            _event: event
        };
    }
    ...
    decodeUpdatedTradeStateEvent(event) {
        let result = event.data;
        return {
            tradeState: new eth_contract_1.BigNumber(result._tradeState),
            _event: event
        };
    }
    ...
    decodeUpdatedWithdrawalFeeRatioEvent(event) {
        let result = event.data;
        return {
            oldWithdrawalFee: new eth_contract_1.BigNumber(result._oldWithdrawalFee),
            newWithdrawalFee: new eth_contract_1.BigNumber(result._newWithdrawalFee),
            _event: event
        };
    }
    assign() {
        ...
        let calcBoost_call = async (options) => {
            ...
            return {
                boost0: new eth_contract_1.BigNumber(result._boost0),
                boost1: new eth_contract_1.BigNumber(result._boost1)
            };
        };
        ...
        let getPairSettings_call = async (options) => {
            ...
            return {
                tradeFee: new eth_contract_1.BigNumber(result._tradeFee),
                tradeState: new eth_contract_1.BigNumber(result._tradeState),
                isXybk: result._isXybk
            };
        };
